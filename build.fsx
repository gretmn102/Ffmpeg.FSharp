...
module CoreProject =
    ...
    Target.create metaTarget (fun _ ->
        ...
        [
            ...
            "    <PackageProjectUrl>https://github.com/gretmn102/Ffmpeg.FSharp/tree/main/src</PackageProjectUrl>"
            "    <PackageLicenseExpression>MIT</PackageLicenseExpression>"
            "    <RepositoryUrl>https://github.com/gretmn102/Ffmpeg.FSharp.git</RepositoryUrl>"
            sprintf "    <PackageReleaseNotes>%s</PackageReleaseNotes>"
                (String.concat "\n" release.Notes |> XmlText.escape)
            "    <PackageTags>fsharp;ffmpeg</PackageTags>"
